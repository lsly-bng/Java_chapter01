	...
	public static void main(String[] args) {
		...
		switch(month) {
			...
			case 12: System.out.println("31일");
				break;
			default: System.out.println("해당 월이 존재하지 않습니다.");
				break;
		}
		 ...
		 * switch (month) {
		   ...
		   //그렇지만 이렇게하면 default 값 때문에 1~12 범위 이외 숫자 입력시 default 값인 31일이 나온다.
		   //하지만 이런 방법으로 응용할 수 있다고 인지하고 있으면 된다.
		 */		
		
		
		/*//alternative (2) : //if 와 || (or) 사용
		 
		 * if ((month==4) || (month==6) || (month==9) || (month==11)) {System.out.print("30일");}
		   	else if (month==2) {System.out.print("28일");}
		    else {System.out.print("31일");}
