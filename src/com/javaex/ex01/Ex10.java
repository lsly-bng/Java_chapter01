...
public class Ex10 {
	...
	public static void main(String[] args) {
		...
		/*
		 * '&&' ampersand-ampersand means 'and'. '||' (right shift+\) vertical
		 * bar-vertical bar means 'or'. '!' exclamation means 'not'. 'deadcode' error
		 * means that there's no point in calculating cause the answer is a given.
		 */
